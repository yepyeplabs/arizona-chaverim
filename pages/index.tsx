      ...
      <section className="relative bg-gray-900 pb-20">
        <nav className="flex justify-between items-center py-8 px-4 xl:px-10">
          ...
          <div className="hidden lg:block">
            <a
              className="inline-block py-3 px-8 text-sm leading-normal font-medium rounded bg-blue-500 bg-opacity-25 hover:bg-opacity-50 text-blue-500 transition duration-200"
              href="#"
            >
              Contact Us
            </a>
